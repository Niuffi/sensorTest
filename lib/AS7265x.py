...
# Calibrated data comes back as IEEE754 encoded number (sign/mantissa/fraction). Need to convert to a float. Page 27
...
# Frequencies of sensors when read out serially are not in ascending order due to overlapping sensor bandwidths.
# Re-order data.
...
def init():
    writeReg(0x04, 1)
    # Experience was the on-board firmware needs a 2s delay after factory reset to get ready.
    # If you poll it immediately you get [Errno 121] Remote I/O error
    time.sleep(4)
